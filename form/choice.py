...
"                }")
    ...
    def retranslateUi(self, Platform):
        ...
        self.label.setText(_translate("Platform", "<h1 style=\'color: #ffffff\'> <b> DataLite <b> </h1>"))
        self.label_2.setText(_translate("Platform", "<div style=\'color: #ffffff; font-size: 14px; line-height: 1.5; margin: 20px; font-family: \"Segoe UI\", Arial, sans-serif;\'>\n"
"    <!-- Заголовок -->\n"
...
"    </div>\n"
"</div>"))
        self.label_3.setText(_translate("Platform", "<h1 style=\'color: #1e3a5f; margin: 15px;\'> 🗂️ Управление датасетами <h1>"))
        ...
        self.delete_button.setText(_translate("Platform", "🗑️ Удалить"))
