...
"}")
    ...
    def retranslateUi(self, Platform):
        ...
        self.label.setText(_translate("Platform", "<h1 style=\'color: #ffffff; font-size: 28px;\'> <b> DataLite <b> </h1>"))
        self.label_2.setText(_translate("Platform", "<div style=\'color: #ffffff; font-size: 16px; line-height: 1.6; margin: 20px; font-family: \"Segoe UI\", Arial, sans-serif;\'>\n"
"    <!-- Заголовок -->\n"
...
"</div>"))
        ...
        self.label_4.setText(_translate("Platform", "<h1 style=\'color: #1e3a5f; margin: 20px; text-align: center; font-size: 26px;\'> 🔧 Инструменты анализа </h1>"))
